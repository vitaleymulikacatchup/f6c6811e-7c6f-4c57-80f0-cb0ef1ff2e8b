...
export const metadata: Metadata = {
  title: "Masandra - Specialty Coffee Shop",
  description: "Discover exceptional specialty coffee at Masandra. Ethically sourced beans, expert roasting, and artisan baristas crafting the perfect cup.",
  keywords: "specialty coffee, coffeeshop, espresso, barista, single-origin coffee, local cafe",
  metadataBase: new URL("https://masandra.com"),
  alternates: {
    canonical: "https://masandra.com"
  },
  openGraph: {
    title: "Masandra - Premium Specialty Coffee",
    description: "Experience exceptional coffee crafted with passion at Masandra",
    type: "website",
    siteName: "Masandra",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766000389395-pf6hll5x.jpg",
        alt: "Masandra Coffeeshop"
      }
    ]
  },
  twitter: {
    ...
    title: "Masandra - Specialty Coffee Shop",
    description: "Exceptional specialty coffee and community",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766000389395-pf6hll5x.jpg"]
  },
  robots: {
    index: true,
    follow: true
